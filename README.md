...
'providers' => [
     ...
     */
    FWM\Roles\RolesServiceProvider::class,
...
Publish the package config file and migrations to your application. Run these commands inside your terminal.
    ...
    php artisan vendor:publish --provider="FWM\Roles\RolesServiceProvider" --tag=config
    php artisan vendor:publish --provider="FWM\Roles\RolesServiceProvider" --tag=migrations
...
```php
use FWM\Roles\Models\Permission;
...
protected $routeMiddleware = [
    ...
    'role' => \FWM\Roles\Middleware\VerifyRole::class,
    'permission' => \FWM\Roles\Middleware\VerifyPermission::class,
    'level' => \FWM\Roles\Middleware\VerifyLevel::class,
];
```
...
It throws `\FWM\Roles\Exceptions\RoleDeniedException`, `\FWM\Roles\Exceptions\PermissionDeniedException` or `\FWM\Roles\Exceptions\LevelDeniedException` exceptions if it goes wrong.
...
{
    if ($e instanceof \FWM\Roles\Exceptions\RoleDeniedException) {
...
For more information, please have a look at [HasRoleAndPermission](https://github.com/romanfastwebmedia/roles/blob/master/src/FWM/Roles/Contracts/HasRoleAndPermission.php) contract.
